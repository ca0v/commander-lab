...
class App {
    run() {
        ...
        program.option("-a, --apples <apples...>", "what kind of apples", (value, prior) => {
        ...
        program.option("-l, --locale <locale>", "target locale", (value) => {
            if (-1 == acceptableLocaleValues.indexOf(value))
                throw "invalid locale";
            return value;
        });
        // validate number
        program.option("-c, --cost <number>", "maximum you are willing to pay", (value) => {
